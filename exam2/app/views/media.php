...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form enctype="multipart/form-data" action="/edit_image" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?php echo ($user['image'] != null) ? $user['image'] : '../public/img/demo/avatars/avatar-m.png'; ?>" alt="Аватар пользователя" class="img-responsive" width="200">
                                </div>
                                <div hidden class="form-group">
                                    <label class="form-label" for="id"></label>
                                    <input type="text" id="id" name="id" class="form-control-file" value="<?php echo $user['id']; ?>">
                                </div>
                                <div class="form-group">
