                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div hidden class="form-group">
                                            ...
                                            <input type="text" id="id" name="id" class="form-control" value="<?php echo $user['id']; ?>">
                                        </div>
                                        <!-- status -->
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status" name="status" ?>
                                                <option <?php echo ($user['status'] == 'Онлайн') ? 'selected' : ''; ?> >Онлайн</option>
                                                <option <?php echo ($user['status'] == 'Отошел') ? 'selected' : ''; ?> >Отошел</option>
                                                <option <?php echo ($user['status'] == 'Не беспокоить') ? 'selected' : ''; ?>>Не беспокоить</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                        <button class="btn btn-warning" type="submit">Установить статус</button>
                                    </div>
                                </div>
                            </div>
                        </div>
