                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags=<?php echo $card['name']; ?>>
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status 
                                    ...
                                    <?php 
                                    if( $card['status'] == 'Онлайн'){
                                        echo 'status-success';
                                    } 
                                    if( $card['status'] == 'Отошел' ){
                                        echo 'status-warning';
                                    }
                                    if( $card['status'] == 'Не беспокоить' ){
                                        echo 'status-danger';
                                    }
                                    ?>
                                     mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url(<?php echo ($card['image'] != null) ? $card['image'] : '../public/img/demo/avatars/avatar-m.png'; ?>); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php endif; ?>
                                        <?php if( $auth->getEmail() == $card['email'] ): ?>
                                            <?php echo '<i class=" hidden fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>';?>
                                            <?php echo '<i class=" hidden fal fa-angle-down d-inline-block ml-1 fs-md"></i>';?>
                                        <?php endif; ?>
                                    </a>
                                            ...
                                            <div class="  dropdown-menu">
                                                <a class="dropdown-item" href="/edit/<?php echo $card['id']; ?>">
                                                    <i class="fa fa-edit"></i>
                                                Редактировать</a>
                                                <a class="dropdown-item" href="/security/<?php echo $card['id']; ?>">
                                                    <i class="fa fa-lock"></i>
                                                Безопасность</a>
                                                <a class="dropdown-item" href="/status/<?php echo $card['id']; ?>">
                                                    <i class="fa fa-sun"></i>
                                                Установить статус</a>
                                                <a class="dropdown-item" href="/media/<?php echo $card['id']; ?>">
                                                    <i class="fa fa-camera"></i>
                                                    Загрузить аватар
                                                </a>
                                                <a href="/delete/<?php echo $card['id']; ?>" class="dropdown-item" onclick="return confirm('Are you sure?');">
                                                    <i class="fa fa-window-close"></i>
                                                    Удалить
                                                </a></div>
                                            
                                    
                                    <span class="text-truncate text-truncate-xl"><?php echo $card['job']; ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <a href="mailto:<?php echo $card['email']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?php echo $card['email']; ?></a>
