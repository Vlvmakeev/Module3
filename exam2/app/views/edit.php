                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="username" class="form-control"  value="<?php echo $user['name']; ?>">
                                </div>

                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="job">Место работы</label>
                                    <input type="text" id="job" name="job" class="form-control" value="<?php echo $user['job']; ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="adress" name="adress" class="form-control" value="<?php echo $user['address']; ?>">
                                </div>
